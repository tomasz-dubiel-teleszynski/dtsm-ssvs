function [K0Q_cP,K1Q_cP,AcP,BcP,AX,BX,AXL,BXL,AcPL,BcPL] = jszloadings(W,mats,dt,kinfQ,K1Q_X,Sigma_cP)
...
[~,BX,~,BXL] = gaussianloadings(mats_periods,dt,K0Q_X,K1Q_X,zeros(N),rho0d*dt,rho1d*dt);
...
[AX,~,AXL] = gaussianloadings(mats_periods,dt,K0Q_X,K1Q_X,Omega_X,rho0d*dt,rho1d*dt);
